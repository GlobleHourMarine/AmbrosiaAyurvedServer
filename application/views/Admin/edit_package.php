            ...
            <div class="content-container navbar-body">
                <div class="container py-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="mb-0" style="color: #5e66d2;">📦 Package List</h2>
                                    ...
                                    <tbody>
                                        <?php if (!empty($product_data)) { ?>
                                            <?php foreach ($product_data as $key => $value) { ?>
                                                <tr>
                                                    <td><?= $key + 1 ?></td>
                                                    <td><strong><?= $value->pack_name ?></strong></td>
                                                    <td>₹<?= $value->base_price ?></td>
                                                    <td>₹<?= $value->price ?></td>
                                                    <td><?= $value->description ?></td>
                                                    <td><span class="badge badge-info"><?= $value->disscount ?>%</span></td>
                                                ...
                                                <!-- Hidden Delete Form -->
                                                <form id="delete-package-form" action="<?= base_url('delete_package'); ?>" method="post" style="display:none;">
                                                ...
                                                <div class="modal fade" id="editPackageModal<?= $value->id ?>" tabindex="-1" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <form action="<?= base_url('update_package'); ?>" method="post">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="pack_name" value="<?= $value->pack_name; ?>" required>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>Base Price <span class="text-danger">*</span></label>
                                                                        <input type="number" class="form-control" name="base_price" value="<?= $value->base_price; ?>" step="0.01" required>
                                                                    </div>
                                                                    <div class="form-group">
                    ...
                    <div class="modal fade" id="addPackageModal" tabindex="-1" aria-labelledby="addPackageModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="<?= base_url('insert_package'); ?>" method="post">
                                <div class="modal-content">
