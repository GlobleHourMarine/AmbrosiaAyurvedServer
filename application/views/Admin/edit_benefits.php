            ...
            <div class="content-container navbar-body">
                <div class="container py-4">
                                    ...
                                    <tbody>
                                        <?php if (!empty($product_data)) { ?>
                                            <?php foreach ($product_data as $key => $value) { ?>
                                                ...
                                                <!-- Hidden Delete Form -->
                                                <form id="delete-package-form" action="<?= base_url('delete_benefits'); ?>" method="post" style="display:none;">
                                                ...
                                                <div class="modal fade" id="editPackageModal<?= $value->id ?>" tabindex="-1" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <form action="<?= base_url('update_benefits'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <?php } else { ?>
                                            <tr>
                                                <td colspan="8" class="text-center text-muted py-4">No Benefits added yet.</td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                    ...
                    <div class="modal fade" id="addPackageModal" tabindex="-1" aria-labelledby="addPackageModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="<?= base_url('insert_benefit'); ?>" method="post" enctype="multipart/form-data">
                                <div class="modal-content">
