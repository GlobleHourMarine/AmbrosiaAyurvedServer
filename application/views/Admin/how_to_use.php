            ...
            <div class="content-container navbar-body">
                <div class="container py-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2 class="mb-0" style="color: #5e66d2;">📦 How To USe</h2>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        <?php if (!empty($product_data)) { ?>
                                            <?php foreach ($product_data as $key => $value) { ?>
                                                <tr>
                                                    <td><?= $key + 1 ?></td>
                                                    <td>
                                                        <img src="<?= base_url($value->image) ?>" alt="Benefit Image" width="80" height="80" style="object-fit: cover;">
                                                    </td>
                                                    <td><strong><?= $value->title ?></strong></td>
                                                    <td><?= $value->step_number ?></td>
                                                ...
                                                <!-- Hidden Delete Form -->
                                                <form id="delete-package-form" action="<?= base_url('delete_step'); ?>" method="post" style="display:none;">
                                                ...
                                                <div class="modal fade" id="editPackageModal<?= $value->id ?>" tabindex="-1" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <form action="<?= base_url('update_step'); ?>" method="post" enctype="multipart/form-data">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="step_number" value="<?= $value->step_number; ?>" required>
                                                                    </div>
                                                                  <div class="form-group">
                                                                        ...
                                                                        <?php if (!empty($value->image)): ?>
                                                                            <div class="mt-2">
                                                                                <img src="<?= base_url($value->image); ?>" alt="Current Image" width="100" height="100" style="object-fit: cover;">
                                        ...
                                        <?php } else { ?>
                                            <tr>
                                                <td colspan="8" class="text-center text-muted py-4">No Steps added yet.</td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
                    ...
                    <div class="modal fade" id="addPackageModal" tabindex="-1" aria-labelledby="addPackageModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <form action="<?= base_url('insert_step'); ?>" method="post" enctype="multipart/form-data">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label>Step Numner <span class="text-danger">*</span></label>
