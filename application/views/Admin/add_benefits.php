                ...
                <div class="row mt-5">
                    <?php foreach ($product_data as $product): ?>
                        ...
                        <div class="card h-100 shadow-sm py-3">
                            <img src="<?= $first_image; ?>" class="card-img-top" alt="<?= htmlspecialchars($product->product_name); ?>" style="height: 200px; object-fit: contain;">
                            <div class="card-body">
                            <h5 class="card-title"><?= $product->product_name; ?></h5>
                            </div>
                            <div class="card-footer bg-white border-top-0 d-flex justify-content-between">
                                <a href="<?= base_url('add_benefits/' . $product->product_id); ?>" 
                                class="btn btn-sm btn-success" 
                                data-bs-toggle="tooltip" 
                                title="Add Benefits">
                                <i class="fas fa-plus-circle me-1"></i>
                                </a>
                                <a href="<?= base_url('how_to_use/' . $product->product_id); ?>" 
                                class="btn btn-sm btn-success" 
                                data-bs-toggle="tooltip" 
                                title="How To Use">
                                <i class="fas fa-book-open me-1"></i>
                                </a>
                                <a href="<?= base_url('faq/' . $product->product_id); ?>" 
                                class="btn btn-sm btn-success" 
                                data-bs-toggle="tooltip" 
                                title="F&Q">
                                <i class="fas fa-book-open me-1"></i>
                                </a>
                                    <!-- <a href="<?//= base_url('ingredients/' . $product->product_id); ?>" 
                                    class="btn btn-sm btn-success" 
                                    data-bs-toggle="tooltip" 
                                    title="How To Use">
                                    <i class="fas fa-book-open me-1"></i>
                                    </a> -->
                                <!-- <a href="<?= base_url('add_benefits/' . $product->product_id); ?>" class="btn btn-sm btn-outline-success">
                                    <i class="fas fa-plus-circle me-1"></i> Add Benefits
                                </a> -->
                            </div>
                            <!-- <div class="card-footer bg-white border-top-0 d-flex justify-content-between">
                                <a href="<?= base_url('add_benefits/' . $product->product_id); ?>" class="btn btn-sm btn-outline-success">
        ...
        $(document).ready(function() {
            ...
            $(".remove-product-btn").click(function() {
                ...
                Swal.fire({
                    ...
                    confirmButtonColor: '#007bff', // Blue confirm button
