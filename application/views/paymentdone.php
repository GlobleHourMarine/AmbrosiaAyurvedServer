                ...
                <div class="medium1" >
                        ...
                        <label for="cod" class="payment-method" style="color:black; !important;"> Cash on Delivery (COD)</label><br>
                            ...
                            <div class="custom-file-upload upload-screenshot">
                                ...
                                <!-- <button type="button" id="payNowButton" style="color:black;font-weight:bold;"class="remove-btn">Pay Now</button> -->
                            </div>
                            
                            </div>
                            <!-- <button type="button" id="payNowButton" class="remove-btn">Pay Now</button> -->
                            <button type="button" id="payNowButton" style="color:black;font-weight:bold;margin-top:30px;"class="remove-btn">Pay Now</button>
                        </div>
                </div>
            </div>
        </form>  
<div id="orderHistoryModal" class="modal">
    <div class="modal-content order-history">
        <span class="close close-history">
            <a href="<?php echo base_url('place_order'); ?>">
                <img src="<?php echo base_url('assets/images/remove.png'); ?>" alt="Close" width="25px" height="25px"/>
            </a>
        </span>
