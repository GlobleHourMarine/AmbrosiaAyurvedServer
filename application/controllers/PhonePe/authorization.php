...
$payload = [
    "client_id" => "SU2506031142531039239175",                          // Enter client_id
    "client_version" => "1",                // Enter client_version
    "client_secret" => "0f0dbd9d-0d6d-46c0-ba46-e85a4bc65b66",       // Enter client_secret
...
function fetchOAuthToken()
{
    ...
    // Optional: Log the error or throw exception for debugging
    log_message('error', 'Payload is not an array in fetchOAuthToken');
    show_error('Invalid payload format');
}
